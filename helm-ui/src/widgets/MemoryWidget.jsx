          ...
          >
            ...
            <div style={{ padding: '16px 18px' }}>
                    ...
                    {Object.entries(entry.full_content).map(([k, v]) => (
                      <div key={k} style={{ display: 'flex', gap: 12, marginBottom: 6 }}>
                        <span
                          ...
                          style={{ color: 'var(--text-dim)', flexShrink: 0, minWidth: 80 }}
                        >
                          {k}
                        </span>
                    ...
                    {entry.entity_refs.map((e) => (
                      <span
                        ...
                        style={{
                          ...
                          padding: '2px 10px',
                          borderRadius: 12,
                          border: '1px solid rgba(125,212,252,0.25)',
                          color: '#7dd4fc',
              ...
              {entry.belief_ref && (
                ...
                >
                  <span
                    style={{ fontFamily: 'var(--sans)', fontSize: 10, color: 'var(--text-dim)' }}
                  >
                    belief →{' '}
                  </span>
                  <span
                    ...
                    <div className="strength-bar-track" style={{ flex: 1 }}>
                      <div
                        ...
                        style={{
                          ...
                          background: `linear-gradient(90deg, ${tc.color}66, ${tc.color})`,
                        }}
                      />
                    </div>
                    <span

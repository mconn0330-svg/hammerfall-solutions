...
export default function PersonalityWidget() {
  const [scores, setScores] = useState(() => Object.fromEntries(PERSONALITY.map(p => [p.attribute, p.score])))
          ...
          return (
            ...
            >
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 10 }}>
                ...
                <span style={{ fontFamily: 'var(--sans)', fontSize: 11, color: 'var(--node-primary)' }}>
                  {score.toFixed(2)}
                </span>
              </div>
              ...
              <p className="body-text-sm" style={{
                ...
                fontStyle: 'italic',
                marginBottom: saved[attr.attribute] !== undefined && saved[attr.attribute] === false ? 8 : 0,
              }}>
                {translation}
              </p>

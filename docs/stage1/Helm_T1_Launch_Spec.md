...
> **⚠️ SUPERSEDED by [Helm_T1_Launch_Spec_V2.md](Helm_T1_Launch_Spec_V2.md) on 2026-04-24.**
> This document is preserved as the historical artifact. All new work references V2 task IDs.
> Do not edit this file. If something here is wrong, fix it in V2.

# Helm T1 Launch — Consolidated Build Specification (v1 — historical)

| | |
|---|---|
| **Status** | 🔒 Superseded by V2 — preserved for historical reference |
| **Version** | v2.0 — revised to include T0 Memory Foundation phase (now superseded) |

...
6. **The Handoff (Staging Protocol)** When you have finalized a Technical Blueprint, you must autonomously save the complete specification as a Markdown file (e.g., `[ProjectName]_UI_Blueprint.md`) directly into the `hammerfall-solutions/staging_area/` directory.

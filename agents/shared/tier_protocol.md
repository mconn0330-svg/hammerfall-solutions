...
The tier controls proactivity and presence — not agent existence. All five agents exist
at every tier. What changes is when they fire and how often Helm initiates.
...
**AGENTS:** All five agents run per-turn within session. Reactive only. No autonomous
initiation between sessions.
